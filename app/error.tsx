...
export default function Error({
  ...
  useEffect(() => {
    console.error('ALTUS Error:', error);
        ...
        <div className="max-w-2xl w-full text-center space-y-8">
          ...
          <div className="space-y-4 opacity-0 animate-fade-up" style={{animationDelay: '100ms'}}>
            ...
            <p className="text-lg md:text-xl text-white/70 font-medium max-w-xl mx-auto leading-relaxed">
              Maaf, terjadi kesalahan pada sistem ALTUS Air Cargo Management. Tim kami telah menerima notifikasi tentang masalah ini.
            </p>
          </div>

          {/* Error Details Box */}
          <div className="bg-white/5 border-2 border-red-500/30 rounded-[12px] p-6 backdrop-blur-sm opacity-0 animate-fade-up" style={{animationDelay: '150ms'}}>
            <div className="space-y-2">
              <p className="text-white/60 font-semibold text-sm uppercase tracking-wide">Error Details</p>
              <p className="text-xl font-mono font-bold text-red-400 break-words">
                {error.message || 'ALTUS-SYSTEM-ERROR'}
              </p>
              {error.digest && (
              ...
              <ul className="text-white/60 text-sm text-left max-w-md mx-auto space-y-1">
                ...
                <li>• Coba akses kembali beberapa saat lagi</li>
              </ul>
            </div>
          </div>
          ...
          <p className="text-white/50 text-sm opacity-0 animate-fade-up" style={{animationDelay: '250ms'}}>
            Jika masalah terus berlanjut, hubungi tim support ALTUS atau kembali ke{' '}
